...
/**
 * Global error fallback component to display when a catastrophic error occurs
 * Updated with glassmorphism design to match other public pages
 */
          ...
          <div className="auth-form-container">
            <div className="glass glass-card p-8 md:p-10 rounded-2xl w-full text-center">
              <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold mb-4 siri-heading">
                  Something went wrong
                </h1>

                <p className="siri-text-subtle mb-8">
                  We're sorry, but ArtiCube has encountered an unexpected error.
                </p>
              ...
              {error && process.env.NODE_ENV !== "production" && (
                <div
                  className="mt-8 text-left border border-opacity-30 rounded-xl p-4"
                  style={{
                    borderColor: "rgba(255, 70, 70, 0.3)",
                    background: "rgba(255, 70, 70, 0.05)",
                  }}
                >
                  <p className="font-medium siri-text mb-2">Error details:</p>
                  <pre className="p-3 rounded text-sm overflow-x-auto bg-black bg-opacity-20 border border-gray-700 border-opacity-20 text-gray-300">
                    {error.toString()}
                  </pre>
                </div>
              )}
